...
admin.site.register(Receipe)  # Corrected the model name to "Recipe" (typo)
...
class ReportCardAdmin(admin.ModelAdmin):
    ...
    # Ensure you add "total_marks" to list_display as well
    list_display += ['total_marks']  # Add this line
